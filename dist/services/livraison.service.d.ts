...
export declare function assignerLivraison(data: {
    commandeId: number;
    livreurId: number;
}): Promise<{
    commande: {
...
export declare function obtenirLivraisons(params: PaginationParams & {
    livreurId?: number;
...
export declare function mettreAJourLivraison(id: number, statut: StatutLivraison, noteProbleme?: string): Promise<{
    id: number;
    statut: import(".prisma/client").$Enums.StatutLivraison;
    commandeId: number;
    livreurId: number;
...
//# sourceMappingURL=livraison.service.d.ts.map